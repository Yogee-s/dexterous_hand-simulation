...
def main():
    ...
    path = xml_path_completion("inspire/urdf/handright9253.xml")
    # link_names = ["palm", "thmiddle", "ffmiddle", "mfmiddle", "rfmiddle", "lfmiddle", "thtip", "fftip", "mftip",
    #               "rftip", "lftip"][:6]
    link_names = ["hand", "R_thumb_intermediate", "R_index_proximal", "R_middle_proximal", "R_ring_proximal", "R_pinky_proximal", "R_thumb_distal", "R_index_distal", "R_middle_distal",
                  "R_ring_distal", "R_pinky_distal"][:6]
    ...
    # target_joint_index = [0, 3, 5, 7, 9, 11, 4, 6, 9, 10, 12 ][:6]
