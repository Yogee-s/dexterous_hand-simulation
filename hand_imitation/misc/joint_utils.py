...
def get_default_joint_mapping():
    joint_mapping = {}
    joint_mapping.update(
        {"R_thumb_MCP_joint1": (1, [0.707, 0, -0.707]), "R_thumb_MCP_joint2": (1, [0.707, 0, 0.707]),
         "R_thumb_PIP_joint": (2, [0, 1, 0]), "R_thumb_DIP_joint": (3, [0, 1, 0]), })
    joint_mapping.update(
        {"R_index_MCP_joint": (4, [0, 0, 1]), "R_index_DIP_joint": (6, [0, 0, 1]), })
    joint_mapping.update(
        {"R_middle_MCP_joint": (7, [-0.173, 0, 0.984]), "R_middle_DIP_joint": (9, [-0.173, 0, 0.984]), })
    joint_mapping.update(
        {"R_ring_MCP_joint": (10, [-0.342, 0, 0.939]), "R_ring_DIP_joint": (12, [-0.342, 0, 0.939]), })
    joint_mapping.update(
        {"R_pinky_MCP_joint": (13, [-0.642, 0, 0.766]), "R_pinky_DIP_joint": (15, [-0.642, 0, 0.766]), })
    return joint_mapping
