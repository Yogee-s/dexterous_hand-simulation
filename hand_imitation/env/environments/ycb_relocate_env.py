...
class YCBRelocate(MujocoEnv):
    ...
    def _pre_action(self, action, policy_step=False):
        ...
        # print("Action Midpoint (self.act_mid):", self.act_mid)
        # print("Action Range (self.act_rng):", self.act_rng)
        # print("Action:", action)
    ...
    def _get_observations(self):
        ...
        return np.concatenate([qp[:self.num_act], palm_pos - obj_pos, palm_pos - target_pos, obj_pos - target_pos])
    ...
    #############################################################################################
        # reward = -0.2 * np.linalg.norm(palm_pos - obj_pos)  # take hand to object
    #############################################################################################
        if is_contact:
            reward += 0.1
    ...
    def _load_model(self):
        ...
        # xml_file = xml_path_completion("inspire_old/urdf/handright9253.xml")
